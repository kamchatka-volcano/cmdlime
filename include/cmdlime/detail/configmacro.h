...
#define COMMAND(name, type) type* name = cmdlime::detail::makeCommandCreator<type>(*this, #name, [this]()->type*&{return name;})
#define SUBCOMMAND(name, type) type* name = cmdlime::detail::makeCommandCreator<type>(*this, #name, [this]()->type*&{return name;}, cmdlime::detail::Command<type>::Type::SubCommand)
